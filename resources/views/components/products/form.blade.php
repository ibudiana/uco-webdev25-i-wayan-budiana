...
<form action="{{ $action }}" method="POST" class="space-y-6" enctype="multipart/form-data">
    ...
    <div class="col-span-full">
        ...
        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 dark:border-gray-50/25 px-6 py-10">
            ...
            <div class="mt-4 flex text-sm/6 text-gray-900 dark:text-gray-50">
