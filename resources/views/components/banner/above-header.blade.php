<div x-data="{ showBanner: getCookie('promoBannerDismissed') !== 'true'  }" x-show="showBanner" x-transition x-cloak
    ...
    <div class="flex flex-1 justify-end">
        <button @click="setCookie('promoBannerDismissed', 'true', 1); showBanner = false" type="button" class="-m-3 p-3 focus-visible:-outline-offset-4">
            <span class="sr-only">Dismiss</span>
            <svg class="size-5 text-gray-50" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
